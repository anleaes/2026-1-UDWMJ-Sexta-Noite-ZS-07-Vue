<template>
  <q-page>
    <section class="bg-secondary q-py-xl">
      <div class="container mx-auto row items-center justify-center q-px-md">
    ...
    <div class="q-py-xl bg-grey-1">
      ...
      <div class="row items-center q-mb-lg q-px-md q-px-md-xl">
      ...
      <div class="row no-wrap q-gutter-md overflow-auto q-pb-md hide-scrollbar q-pl-md q-pl-md-xl">
        <div 
